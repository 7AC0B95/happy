...
#if defined(NDEBUG)
# error "triangleearth cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "triangleearth Signed Message:\n";
                              ...
                              bool fOverrideMempoolLimit, const CAmount& nAbsurdFee, std::vector<COutPoint>& coins_to_uncache)
{
...

    {
        ...
        {
            LogPrint(BCLog::MEMPOOL, "replacing tx %s with %s for %s TES additional fees, %d delta bytes\n",
