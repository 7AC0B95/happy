...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s triangleearth-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  triangleearth-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded triangleearth transaction") + "\n" +
              "  triangleearth-tx [options] -create [commands]   " + _("Create hex-encoded triangleearth transaction") + "\n" +
              "\n";
